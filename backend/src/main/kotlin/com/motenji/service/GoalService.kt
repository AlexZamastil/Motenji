...
class GoalService(
    ...
    fun createGoal(createDTO: GoalCreateDTO): ResponseEntity<com.motenji.utility.ResponseWrapper<String>> {
        val goal = Goal(
            id = null,
            name = createDTO.name,
    ...
    fun getAllGoalsOfUser(userId: Long): ResponseEntity<com.motenji.utility.ResponseWrapper<List<GoalInfoDTO>>> {
    ...
    fun contributeToGoal(goalId: Long, contributionDTO: ContributionDTO): ResponseEntity<com.motenji.utility.ResponseWrapper<String>> {
        val goal =
    ...
    fun deleteGoal(goalId: Long): ResponseEntity<com.motenji.utility.ResponseWrapper<String>> {
        val goal =
            goalRepository.findGoalById(goalId) ?: return ResponseFactory.notFound("Goal for this user not found")
    ...
    fun getGoalInfo(goalId: Long): ResponseEntity<com.motenji.utility.ResponseWrapper<com.motenji.DTO.GoalContributionsDTO>> {
        val goal =
            goalRepository.findGoalById(goalId) ?: return ResponseFactory.notFound("Goal for this user not found")
    ...
    fun deleteContribution(contributionId: Long): ResponseEntity<com.motenji.utility.ResponseWrapper<String>> {
